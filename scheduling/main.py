                        ...
                        for room in rndRoomList: 
                            if (course.get_students() <= room.get_capacity()):
                                ...
                                try:
                                    ...
                                    if(nextTime._time.get_id() not in occupiedTimes):
                                        myDoubleClass = Class(counter, course, nextTime._time.get_id(), room)
                                        nextTime.set_Occupied()
                                        occupiedTimes[nextTime._time.get_id()] = nextTime._time.get_id()
                                    ...
                                    pass
                                break
                                # breaks room loop by the next time availability check
                            else:
                                self.add_conflict()
